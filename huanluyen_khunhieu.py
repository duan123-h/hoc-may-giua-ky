...
print("Đã lưu bộ chuẩn hóa lần 1 vào file scaler.joblib")
...
print("Đã lưu bộ chuẩn hóa lần 2 vào file scaler.joblib")
...
while True:
    ...
    if graph and k % 50 == 0:
        ...
        print(f'Vòng lặp {k}: RMSE = {np.sqrt(mean_squared_error(y_train, y_pred)):.2f}')
        plt.cla()
